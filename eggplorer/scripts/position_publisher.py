...
class JointAnglePositionPublisher(Node):
    def __init__(self):
        ...
        self.joint_2_initial_angle = math.radians(900)
        self.joint_3_initial_angle = math.radians(0)
        self.joint_4_initial_angle = math.radians(900)

        self.joint_1_final_angle = math.radians(900)
        self.joint_2_final_angle = math.radians(0)
        self.joint_3_final_angle = math.radians(900)
        self.joint_4_final_angle = math.radians(0)
